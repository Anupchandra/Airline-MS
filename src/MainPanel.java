...
public class MainPanel extends JFrame {
	...
	public MainPanel() {
		...
		gbl_contentPane.rowHeights = new int[]{0, 0, 0, 48, 0, 0, 0, 31, 0, 0, 0, 0};
		...
		gbc_btnRescheduleTicket.insets = new Insets(0, 0, 5, 0);
		...
		gbc_btnTicketStatus.insets = new Insets(0, 0, 5, 0);
